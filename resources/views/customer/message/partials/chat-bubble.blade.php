@foreach($messages as $msg)
    ...
    <div class="flex justify-start mb-4 gap-3">
        <div class="w-8 h-8 rounded-full bg-gray-800 flex-shrink-0 flex items-center justify-center text-xs font-bold text-white">
            A
        </div>
        <div class="flex flex-col items-start max-w-[80%]">
            <div class="bg-gray-100 px-4 py-2.5 rounded-2xl rounded-tl-none text-sm text-gray-800 leading-relaxed border border-gray-200">
                {{ $msg->admin_reply }}
            </div>
