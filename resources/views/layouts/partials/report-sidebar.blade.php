<nav class="bg-white shadow-lg rounded-xl border border-gray-200 p-4">
    <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider px-3 mb-2">Menu Laporan</h3>
    <div class="space-y-1">
        ...
        <a href="{{ route('admin.journal.index') }}" 
           class="group flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 {{ Request::routeIs('admin.journal.index') ? 'bg-orange-100 text-orange-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}">
        ...
        <a href="{{ route('admin.ledger.index') }}" 
           class="group flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 {{ Request::routeIs('admin.ledger.index') ? 'bg-orange-100 text-orange-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}">
